...
"<input type=\"text\" name=\"q\"> <input type=\"submit\" value=\"search\">";
    ...
    if ( logged_in() eq 1 ) {
        print
"<a class=\"tools\" href=\"$site_url/insipid.cgi?op=options\">options</a> | ";
        print
"<a class=\"tools\" href=\"$site_url/insipid.cgi?op=tags\">tags</a> | ";
        print
"<a class=\"tools\" href=\"$site_url/insipid.cgi?op=import\">import</a> | ";
        print
"<a class=\"tools\" href=\"$site_url/insipid.cgi?op=export\">export</a> | ";
        print
"<a class=\"tools\" href=\"$site_url/insipid.cgi?op=snapshots\">snapshots</a> | ";
        print
"<a class=\"tools\" href=\"$site_url/insipid.cgi?op=logout\">logout</a><br />";
        print
"<a class=\"tools\" href=\"$site_url/insipid.cgi?op=add_bookmark\">add</a> | ";
        print
"<a class=\"tools\" href=\"$site_url/insipid.cgi?op=bookmarklets\">bookmarklets</a> | ";
    }
    ...
    if ( logged_in() ne 1 ) {
        print
" | <a class=\"tools\" href=\"$site_url/insipid.cgi?op=login\">login</a>";
    }

    print
" | <a class=\"tools\" href=\"javascript:void window.open('$site_url/help.html','width=300,height=500');\">help</a> ";
    print
" | <a class=\"tools\" href=\"http://www.neuro-tech.net/insipid/\">source</a>";
...
sub show_bookmarks {
    ...
    if ( $query ne "" ) {
            ...
            || ( logged_in() eq 1 ) )
        {
            ...
            if ( length($sparm) > 2 ) {
                $sql =
"$sql where ($tbl_bookmarks.title || $tbl_bookmarks.description like ?)";
                $sparm =~ s/\%//;
                $sparm = "\%$sparm\%";
                push( @parms, $sparm );
            }
